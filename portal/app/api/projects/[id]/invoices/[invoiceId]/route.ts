...
const ALLOWED = ["invoice_number", "party_type", "contractor_id", "supplier_id", "supplier_name", "purchase_order_id", "amount", "currency", "status", "invoice_date", "due_date", "paid_date", "notes", "milestone"];
