      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="mt-6 mb-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
          <div className="flex items-center gap-4">
            <div className={`w-16 h-16 rounded-xl ${logoColor(c.company_name)} flex items-center justify-center text-white font-bold text-lg shrink-0`}>
              {initials(c.company_name)}
            </div>
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-xl font-bold">{c.company_name}</h1>
                {c.company_id && (
                  <Link
